...
***NOTE***
Currently the way the program is setup could be improved: 
*Consistent use of global variables along with initilzaing functions create some redundancy and spots for issues to occour.
*
